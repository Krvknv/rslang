...
const registerTeam = () => {
    ...
    const victor = createTeamItem(
        'victor',
        'Виктор',
        'Работа с авторизацией, верстка и работа с функционалом игры "Аудиовызов"'
    );
    const kristina = createTeamItem(
        'kristina',
        'Кристина',
        'Разработка дизайна, верстка главной страницы, работа с учебником и со статистикой'
    );
    const evgeniy = createTeamItem(
        'evgeniy',
        'Евгений',
        'Локальная настройка бека, верстка и работа с функционалом игры "Спринт"'
    );
